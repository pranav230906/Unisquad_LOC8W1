...
export default function WorkerSettings() {
    ...
    return (
        <div className="animate-in space-y-4 max-w-3xl pb-10">
            <h1 className="text-[20px] font-bold text-[#111827] mb-4">Settings</h1>
            ...
            <div className="bg-white border border-[#E5E7EB] rounded-[10px] shadow-sm overflow-hidden mb-4">
                <div className="px-4 py-3 border-b border-[#F3F4F6] flex items-center gap-3">
                    ...
                    <h2 className="text-[16px] font-bold text-[#111827]">Notifications</h2>
                </div>
                <div className="divide-y divide-[#F3F4F6]">
                    <div className="p-4 flex items-center justify-between bg-white hover:bg-[#F9FAFB] transition-colors">
                        <div>
                            <h3 className="text-[15px] font-bold text-[#111827] leading-none mb-1">Job Alerts</h3>
                            <p className="text-[12px] font-semibold text-[#6B7280]">Get notified about nearby jobs</p>
                        </div>
                        <Toggle active={jobAlerts} onChange={() => setJobAlerts(!jobAlerts)} />
                    </div>
                    <div className="p-4 flex items-center justify-between bg-white hover:bg-[#F9FAFB] transition-colors">
                        <div>
                            <h3 className="text-[15px] font-bold text-[#111827] leading-none mb-1">Message Notifications</h3>
                            <p className="text-[12px] font-semibold text-[#6B7280]">Receive messages from employers</p>
                        </div>
                        <Toggle active={msgNotifs} onChange={() => setMsgNotifs(!msgNotifs)} />
                    </div>
                    <div className="p-4 flex items-center justify-between bg-white hover:bg-[#F9FAFB] transition-colors">
                        <div>
                            <h3 className="text-[15px] font-bold text-[#111827] leading-none mb-1">Earnings Updates</h3>
                            <p className="text-[12px] font-semibold text-[#6B7280]">Get notified when payments are received</p>
                        </div>
            ...
            <div className="bg-white border border-[#E5E7EB] rounded-[10px] shadow-sm overflow-hidden mb-4">
                ...
                <div className="divide-y divide-[#F3F4F6]">
                    <div className="p-4 flex items-center justify-between bg-white hover:bg-[#F9FAFB] transition-colors">
                        <div>
                            <h3 className="text-[15px] font-bold text-[#111827] leading-none mb-1">Dark Mode</h3>
                            <p className="text-[12px] font-semibold text-[#6B7280]">Enable dark theme</p>
                        </div>
                        <Toggle active={darkMode} onChange={() => setDarkMode(!darkMode)} />
                    </div>
                    <div className="p-4 flex items-center justify-between bg-white hover:bg-[#F9FAFB] transition-colors">
                        <div>
                            <h3 className="text-[15px] font-bold text-[#111827] leading-none mb-1">Language</h3>
            ...
            <div className="bg-white border border-[#E5E7EB] rounded-[10px] shadow-sm overflow-hidden mb-4">
                <div className="px-4 py-3 border-b border-[#F3F4F6] flex items-center gap-3">
                    ...
                    <h2 className="text-[16px] font-bold text-[#111827]">Privacy & Security</h2>
                </div>
            ...
            <div className="bg-white border border-[#E5E7EB] rounded-[10px] shadow-sm overflow-hidden mb-6">
                <div className="px-4 py-3 border-b border-[#F3F4F6] flex items-center gap-3">
                    ...
                    <h2 className="text-[16px] font-bold text-[#111827]">Help & Support</h2>
                </div>
                <div className="divide-y divide-[#F3F4F6] p-3 flex flex-col gap-2">
                    <button
